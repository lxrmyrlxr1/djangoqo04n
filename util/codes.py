...
crud_error_code = 10021  # 数据库operate失败
header_error_code = 10023  # 头部错误
captcha_error_code = 10024  # 验证码错误
id_exist_code = 10025  # id或username已存在
id_notexist_code = 10026  # id或username不存在
username_error_code = 10027  # username错误
password_error_code = 10028  # password错误
