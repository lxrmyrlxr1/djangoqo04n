...
<div class="content box6" :style='{"alignContent":"flex-start","minHeight":"100vh","flexWrap":"wrap","background":"#180312","display":"flex","width":"100%","position":"relative","height":"auto"}'>
	<!-- title -->
	<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,.1)","width":"100%","lineHeight":"64px","fontSize":"28px","height":"64px"}'>Welcome {{this.$project.projectName}}</div>
	<!-- 时间 -->
	...
	<!-- system introduce -->
	<div v-if="systemIntroductionDetail" :style='{"padding":"20px","margin":"0 1% 20px 3%","flexWrap":"wrap","background":"rgba(255,255,255,.1)","display":"flex","width":"66%","height":"200px"}'>
	...
	<div :style='{"alignContent":"flex-start","padding":"20px","margin":"0 3% 20px 1%","flexWrap":"wrap","background":"rgba(255,255,255,.1)","display":"flex","width":"26%","height":"200px"}'>
		...
		<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,.1)","justifyContent":"center","display":"flex"}'>
			...
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","height":"32px"}'>ticket information numbers</div>
				<div :style='{"lineHeight":"32px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{menpiaoxinxiCount}}</div>
			</div>
		</div>
		...
		<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,.2)","justifyContent":"center","display":"flex"}'>
			...
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","height":"32px"}'>hotel information numbers</div>
				<div :style='{"lineHeight":"32px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{mingsuxinxiCount}}</div>
			</div>
		</div>
            ...
            <div class="echarts1">
                <div id="menpiaoxinxiChart1" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts2">
                <div id="mingsuxinxiChart2" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts3">
                <div id="mingsuxinxiChart3" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts4">
                <div id="mingsuxinxiChart4" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts5">
                <div id="mingsuxinxiChart5" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts6">
                <div id="mingsuxinxiChart6" style="width:100%;height:100%;"></div>
            </div>
</div>
...
export default {
  ...
  mounted(){
    ...
    this.menpiaoxinxiChat1();
    this.getmingsuxinxiCount();
    this.mingsuxinxiChat2();
    this.mingsuxinxiChat3();
    this.mingsuxinxiChat4();
    this.mingsuxinxiChat5();
    this.mingsuxinxiChat6();
  },
  created() {
    this.$nextTick(()=>{
		this.times()
...
//统计接口1
    menpiaoxinxiChat1() {
      this.$nextTick(()=>{
        ...
        var menpiaoxinxiChart1 = echarts.init(document.getElementById("menpiaoxinxiChart1"),'macarons');
        this.$http({
            url: `menpiaoxinxi/value/biaoti/jiage`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                menpiaoxinxiChart1.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    menpiaoxinxiChart1.resize();
                };
            }
        });
      })
...
//统计接口1
    mingsuxinxiChat2() {
      this.$nextTick(()=>{
        ...
        var mingsuxinxiChart2 = echarts.init(document.getElementById("mingsuxinxiChart2"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				titleObj.text = 'evaluate statistics'
                ...
                // 使用刚指定的配置项和数据显示图表。
                mingsuxinxiChart2.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    mingsuxinxiChart2.resize();
                };
            }
        });
      })
...
//统计接口2
    mingsuxinxiChat3() {
      this.$nextTick(()=>{
        ...
        var mingsuxinxiChart3 = echarts.init(document.getElementById("mingsuxinxiChart3"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                let titleObj = this.bar.title
				titleObj.text = 'hotelClassification'
                ...
                // 使用刚指定的配置项和数据显示图表。
                mingsuxinxiChart3.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    mingsuxinxiChart3.resize();
                };
            }
        });
      })
...
//统计接口3
    mingsuxinxiChat4() {
      this.$nextTick(()=>{
        ...
        var mingsuxinxiChart4 = echarts.init(document.getElementById("mingsuxinxiChart4"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                mingsuxinxiChart4.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    mingsuxinxiChart4.resize();
                };
            }
        });
      })
...
//统计接口4
    mingsuxinxiChat5() {
      this.$nextTick(()=>{
        ...
        var mingsuxinxiChart5 = echarts.init(document.getElementById("mingsuxinxiChart5"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
				let titleObj = this.line.title
				titleObj.text = 'number of ratings'
                ...
                // 使用刚指定的配置项和数据显示图表。
                mingsuxinxiChart5.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    mingsuxinxiChart5.resize();
                };
            }
        });
      })
...
//统计接口5
    mingsuxinxiChat6() {
      this.$nextTick(()=>{
        ...
        var mingsuxinxiChart6 = echarts.init(document.getElementById("mingsuxinxiChart6"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                mingsuxinxiChart6.setOption(option);


                  //根据窗口的大小变动图表
                window.onresize = function() {
                    mingsuxinxiChart6.resize();
                };
            }
        });
      })
