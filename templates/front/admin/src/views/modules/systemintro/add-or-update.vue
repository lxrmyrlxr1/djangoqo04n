<template>
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="title" prop="title">
					<el-input v-model="ruleForm.title" placeholder="title" clearable  :readonly="ro.title"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="title" prop="title">
					<el-input v-model="ruleForm.title" placeholder="title" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="subtitle" prop="subtitle">
					<el-input v-model="ruleForm.subtitle" placeholder="subtitle" clearable  :readonly="ro.subtitle"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="subtitle" prop="subtitle">
					<el-input v-model="ruleForm.subtitle" placeholder="subtitle" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture1" label="picture1" prop="picture1">
					<file-upload
						tip="Click Upload picture1"
						action="file/upload"
						:limit="3"
						:multiple="true"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture1" label="picture1" prop="picture1">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture2" label="picture2" prop="picture2">
					<file-upload
						tip="Click Upload picture2"
						action="file/upload"
						:limit="3"
						:multiple="true"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture2" label="picture2" prop="picture2">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture3" label="picture3" prop="picture3">
					<file-upload
						tip="Click Upload picture3"
						action="file/upload"
						:limit="3"
						:multiple="true"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture3" label="picture3" prop="picture3">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="context" prop="content">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.content" label="context" prop="content">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				content: [
					{ required: true, message: 'context不能为空', trigger: 'blur' },
				],
				picture1: [
				],
				picture2: [
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../djangoqo04n/upload');
        } else {
