<template>
  <div :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}'>
    <el-form
      ...
      label-width="180px"
    >
      <el-form-item :style='{"margin":"0 0 20px 0"}' label="Original password" prop="password">
        <el-input v-model="ruleForm.password" show-password></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 0 20px 0"}' label="new password" prop="new password">
        <el-input v-model="ruleForm.new password" show-password></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 0 20px 0"}' label="Confirm Password" prop="repassword">
    ...
    onUpdateHandler() {
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          ...
          if (this.ruleForm.new password != this.ruleForm.repassword) {
            this.$message.error("两次password输入不一致");
            return;
          }
          this.user.password = this.ruleForm.new password;
          this.user.mima = this.ruleForm.new password;
          this.$http({
            ...
            if (data && data.code === 0) {
              this.$message({
                message: "Revise passwordsuccess,下次login系统生效",
                type: "success",
                duration: 1500,
                onClose: () => {
                }
