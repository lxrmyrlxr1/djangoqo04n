...
const toolbarOptions = [
  ["bold", "italic", "underline", "strike"], // 加粗 斜体 下划线 deleted线
...
export default {
  ...
  data() {
    return {
      content: this.value,
      quillUpdateImg: false, // 根据picture上传状态来confirm是否显示loading动画，刚开始是false,不显示
      editorOption: {
        placeholder: "",
  ...
  methods: {
    ...
    uploadSuccess(res, file) {
      ...
      if (res.code === 0) {
        ...
        // 插入picture  res.url为服务器返回的pictureaddress
