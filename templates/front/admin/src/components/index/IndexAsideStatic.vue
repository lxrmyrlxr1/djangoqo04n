		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"#333"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					...
					<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"16px"}'>System Home</span>
				</el-menu-item> -->
				...
				<el-submenu index="1">
					<template slot="title">
						...
						<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"16px"}'>Personal Center</span>
					</template>
					<el-menu-item index="1-1" @click="menuHandler('updatePassword')">Revise password</el-menu-item>
